...
3. Enter password: `REDACTED_LEGACY_PASSWORD`
...
2. Line 3247: `const CRM_PASSWORD = 'REDACTED_LEGACY_PASSWORD';`
...
|---------------|----------|-----------------|
| Web Browser | `REDACTED_LEGACY_PASSWORD` | `index.html` line 3247 |
...
The web password `REDACTED_LEGACY_PASSWORD` is a default. **Change it immediately!**

1. Open `capitalcitycontractors/index.html`
2. Find line 3247: `const CRM_PASSWORD = 'REDACTED_LEGACY_PASSWORD';`
